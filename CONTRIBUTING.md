# How to contribute to Mycozyapp?
...
- What is the version of the Cozy Mycozyapp?
...
```
$ git clone github.com/ben/mycozyapp.git
$ cd mycozyapp
$ git remote add fork git://github.com/yourusername/mycozyapp.git
```
...
Go to https://github.com/yourusername/mycozyapp and select your branch. Click the 'Pull Request' button and fill out the form.
...
The Mycozyapp is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/ben/mycozyapp/issues/new
...
[localization]: https://github.com/ben/mycozyapp/blob/master/README.md#localization
