[![Travis build status shield](https://img.shields.io/travis/ben/mycozyapp/master.svg)](https://travis-ci.org/ben/mycozyapp)
[![Github Release version shield](https://img.shields.io/github/tag/ben/mycozyapp.svg)](https://github.com/ben/mycozyapp/releases)
...
```sh
$ git clone https://github.com/ben/mycozyapp.git
$ cd mycozyapp
$ yarn install
```
...
your app is available at http://mycozyapp.cozy.tools:8080.
...
The lead maintainer for Mycozyapp is [ben](https://github.com/ben), send him/her a :beers: to say hello!
...
Mycozyapp is developed by ben and distributed under the [AGPL v3 license][agpl-3.0].
